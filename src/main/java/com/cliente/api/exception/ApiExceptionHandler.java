...
class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, 
	    ...
	    String detalhe = String.format("O parâmetro '%s' recebeu o valor '%s', que é de um tipo inválido. "
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
		...
		String detalhe = String.format("A propriedade '%s' recebeu o valor '%s', que é do tipo inválido. "
				+ "Corrija e informe um valor compatível com o tipo %s", caminho, ex.getValue(), 
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
		...
		String detalhe = String.format("A propriedade '%s' é inválida. Remova a propriedade e tente novamente", caminho);
	...
	private ResponseEntity<Object> handleRecursoJaExiste(RecursoJaExisteException ex, WebRequest request) {
		...
		String detalhe = String.format("%1$s já existe. Por favor, insira um(a) %1$s com um e-mail diferente", ex.getMessage());
